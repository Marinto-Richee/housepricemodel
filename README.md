...
![output](./static/images/image.png)

## RESULT:
Thus a website is designed to train the house price model and to predict the price and is hosted in the URL http://marinto.student.saveetha.in:8000/HouseModelTraining/ and http://marinto.student.saveetha.in:8000/HouseModelPrediction/.